...
export const AddPage = () => {
  ...
  const onAddOrUpdatePageHandler = async (e) => {
    ...
    const updatedAddPageData = {
      fk_moduleId: addPageData.fk_moduleId,
      fk_pagetypeId: addPageData.fk_pagetypeId,
      menucaption: addPageData.menucaption,
      pagename: addPageData.pagename,
      displayorder: parseInt(addPageData.displayorder),
      pagepath: addPageData.pagepath,
      tooltip: addPageData.tooltip,
      pageimage: addPageData.pageimage,
      Active: addPageData.isActive,
      remarks: addPageData.remarks,
      pageIndex: 1,
      pageSize: 10,
      actionPageId_enc: pageData.pk_pageId_enc,
    };
    setIsUpdatingPage(true);
    console.log("updatedAddPageData", updatedAddPageData);
    try {
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={6} md={3}>
              <TextField
                ...
                value={addPageData.displayorder}
